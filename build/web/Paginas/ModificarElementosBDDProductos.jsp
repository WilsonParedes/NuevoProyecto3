...
<section>
    ...
    <form action="" class="was-validated" id="TablaPrincipalIngresoClientes" method="POST">
        <div class="form-group">
            <h5>El dato que se cambiara de la tabla es el nombre de producto: <% out.print(buscarElemento);%></h5>
            <br>
            Ingrese Nombre Completo: <input pattern="[A-Za-Z]" class="form-control" maxlength="30" name="txtNombreProductoVentanaEmergente" id ="txtNombreProductoVentanaEmergente" required>
    ...
    %>
         <%
           VariablesGlobales.gestion.modificarregistro(VariablesGlobales.BDDProductos,buscarElemento, cambiarElemento);
